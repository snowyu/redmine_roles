...
class ProjectWorkflowSettingsController < ApplicationController
  unloadable
  layout 'base'
  ...
  def edit
    ...
    if request.post?
      ...
      if @role.save
        ...
        redirect_to :controller => 'projects', :action => "settings", :id => @project, :role_id => @role, :tracker_id => @tracker, :tab => 'project_workflow'
      end
    end
